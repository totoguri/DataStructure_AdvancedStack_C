...
//		}
//		else {
//			printf("Error for Calculation\n");
//		}
//		deleteLinkedStack(pStack);
//	}
//}
//
//void convertInfixToPostfix(ExprToken* pExprTokens, int tokenCount) {	// 피연산자는 그냥 바로 출력하고 연산자만 스택에 넣었다가 뺀다
//	LinkedStack* pStack = NULL;
...
//				break;
//			case rparen:
//				pNode = popLS(pStack);	// 갑자기 왜 pStack이 생겼을까.
